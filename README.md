...
The results can be reproduced by uploading data in the system and processing it in Bio-SODA as described above. For example, official datasets for the QALD4 biomedical benchmark can be downloaded from [here](https://github.com/ag-sc/QALD/tree/master/4/data).
